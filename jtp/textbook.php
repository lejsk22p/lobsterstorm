                ...
                <div class="da-container clearfix">
                    ...
                    <div id="da-breadcrumb">
                        <ul>
                            ...
                            <li class="active"><a href="#">Textbooks</a></li>
        ...
        <div id="da-content">
            ...
            <div class="da-container clearfix">
                ...
                <div id="da-sidebar">
                    ...
                    <!-- sidebar navigation -->
                    <?php include('core/navigation_books.php'); ?>               
                ...
                <div id="da-content-wrap" class="clearfix">
                    ...
                    <!-- Content Area -->
                    <?php
                    $result = mysql_query("SELECT * FROM items WHERE Ftypebook LIKE '%textbook%' ORDER BY Ftime DESC");
