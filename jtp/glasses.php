            ...
            <div id="da-header-bottom">
                ...
                <div class="da-container clearfix">
                    ...
                    <div id="da-breadcrumb">
                        <ul>
                            <li><a href="accessoriesAll.php">Accessories</a></li>
                            <li class="active"><a href="#">Glasses</a></li>
        ...
        <div id="da-content">
            ...
            <div class="da-container clearfix">
                ...
                <div id="da-sidebar">
                    ...
                    <!-- sidebar navigation -->
                    <?php include('core/navigation_accessories.php'); ?>
                ...
                <div id="da-content-wrap" class="clearfix">
                    ...
                    <!-- Content Area -->
                    <?php
                    $result = mysql_query("SELECT * FROM items WHERE Ftypeacc LIKE '%glasses%' ORDER BY Ftime DESC");
