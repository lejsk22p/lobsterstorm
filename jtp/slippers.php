                ...
                <div class="da-container clearfix">
                    ...
                    <div id="da-breadcrumb">
                        <ul>
                            ...
                            <li class="active"><a href="#">Slippers</a></li>
        ...
        <div id="da-content">
            ...
            <div class="da-container clearfix">
                ...
                <div id="da-sidebar">
                    ...
                    <!-- sidebar navigation -->
                    <?php include('core/navigation_shoes.php'); ?>
                ...
                <div id="da-content-wrap" class="clearfix">
                    ...
                    $result = mysql_query("SELECT * FROM items WHERE Ftypeshoes LIKE '%slippers%' ORDER BY Ftime DESC");
