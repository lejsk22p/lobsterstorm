            ...
            <div id="da-header-bottom">
                ...
                <div class="da-container clearfix">
                    ...
                    <div id="da-breadcrumb">
                        <ul>
                            <li><a href="clothesAll.php"><img src="images/icons/black/16/dress.png" alt="Clothes" />Clothing</a></li>
        ...
        <div id="da-content">
            ...
            <div class="da-container clearfix">
                ...
                <div id="da-content-wrap" class="clearfix">
                    ...
                    $result = mysql_query("SELECT * FROM items WHERE Ftypeclothing LIKE '%top%' ORDER BY Ftime DESC");
