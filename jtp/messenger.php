            ...
            <div id="da-header-bottom">
                ...
                <div class="da-container clearfix">
                    ...
                    <div id="da-breadcrumb">
                        <ul>
                            <li><a href="#">Bags</a></li>
                            <li class="active"><span>Messenger</span></li>
        ...
        <div id="da-content">
            ...
            <div class="da-container clearfix">
                ...
                <div id="da-sidebar">
                    ...
                    <!-- sidebar navigation -->
                    <?php include('core/navigation_bags.php'); ?>
                ...
                <div id="da-content-wrap" class="clearfix">
                    ...
                    <!-- Content Area -->
                    <?php
                    $result = mysql_query("SELECT * FROM items WHERE Ftypebags LIKE '%messenger%' ORDER BY Ftime DESC");
