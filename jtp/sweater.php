            ...
            <div id="da-header-bottom">
                ...
                <div class="da-container clearfix">
                    ...
                    <div id="da-breadcrumb">
                        <ul>
                            <li><a href="clothesAll.html">Clothes</a></li>
                            <li class="active"><span>Sweater</span></li>
        ...
        <div id="da-content">
            ...
            <div class="da-container clearfix">
                ...
                <div id="da-content-wrap" class="clearfix">
                    ...
                    $result = mysql_query("SELECT * FROM items WHERE Ftypeclothing LIKE '%sweater%' ORDER BY Ftime DESC");
