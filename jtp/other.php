            ...
            <div id="da-header-bottom">
                ...
                <div class="da-container clearfix">
                    ...
                    <div id="da-breadcrumb">
                        <ul>
                            <li><a href="dormAll.php">Dorm & others</a></li>
                            <li class="active"><a href="#">Everything else</a></li>
        ...
        <div id="da-content">
            ...
            <div class="da-container clearfix">
                ...
                <div id="da-sidebar">
                    ...
                    <!-- sidebar navigation -->
                    <?php include('core/navigation_dorm.php'); ?>
                ...
                <div id="da-content-wrap" class="clearfix">
                    ...
                    <!-- Content Area -->
                    <?php
                    $result = mysql_query("SELECT * FROM items WHERE Ftypedorm LIKE '%other%' ORDER BY Ftime DESC");
