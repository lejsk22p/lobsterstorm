/*
 * Dandelion Admin v1.1 - Customizer JS
 *
...
(function($) {
	$(document).ready(function(e) {
		...
		$select = $(document.createElement('select')).attr('id', 'da-header-pat').bind('change', function(e) {
			$('div#da-header #da-header-top #da-header-top-second').css('background-image', 'url(' + headerPatterns[$(this).val()].file + ')');
			e.preventDefault();
		});
