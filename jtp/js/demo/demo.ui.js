...
(function($) {
	$(document).ready(function(e) {
		...
		$("#da-ex-dialog-div-contactSeller").dialog({
			autoOpen: false, 
		...
		$("#da-ex-dialog-div-disclaimer").dialog({
			autoOpen: false, 
			title: "Disclaimer", 
			modal: true, 
			width: "640", 
		...
		$("#da-ex-dialog-contactSeller").bind("click", function(event) {
			$("#da-ex-dialog-div-contactSeller").dialog("option", {modal: false}).dialog("open");
		...
		// 	event.preventDefault();
		// });
		$("#da-ex-dialog-disclaimer").bind("click", function(event) {
			$("#da-ex-dialog-div-disclaimer").dialog("option", {modal: true}).dialog("open");
			event.preventDefault();
		});
